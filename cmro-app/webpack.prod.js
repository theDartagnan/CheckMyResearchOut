/* eslint-disable no-unused-vars, import/no-extraneous-dependencies, prefer-destructuring,
import/order */
...
module.exports = {
  ...
  // Sortie
  output: {
    path: path.join(__dirname, '../src/main/resources/static'), // chemin obligatoirement absolu
